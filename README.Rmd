...
[![Travis build status](https://travis-ci.org/teunbrand/ggnomics.svg?branch=BioC)](https://travis-ci.org/teunbrand/ggnomics)
...
It only works with 'ggplot2' version >3.3.0.9000, i.e. their master branch.
