...
[![Codecov test coverage](https://codecov.io/gh/teunbrand/ggnomics/branch/master/graph/badge.svg)](https://codecov.io/gh/teunbrand/ggnomics?branch=BioC)
<!-- badges: end -->
...
It would probably only work with the current release candidate of ggplot2, which you can install as such:
...
There are no examples yet. It is still under construction. Will post more once something might actually be useful.
...
* Cannot execute evaluation of aesthetics when the referred column is S4
