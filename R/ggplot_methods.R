...
# Might need more specialised behaviour for the more complicated data containers
# i.e. SummarizedExperiment and derivatives when it can't be handled at the
# fortify stage.
